...
@overloaddef _to_rust_image_preprocessing_config(value: ImagePreprocessingConfig | dict[str, Any] | str) -> _rust.ImagePreprocessingConfig: ...
...
@overloaddef _to_rust_tesseract_config(value: TesseractConfig | dict[str, Any] | str) -> _rust.TesseractConfig: ...
...
@overloaddef _to_rust_ocr_element_config(value: OcrElementConfig | dict[str, Any] | str) -> _rust.OcrElementConfig: ...
...
@overloaddef _to_rust_ocr_quality_thresholds(value: OcrQualityThresholds | dict[str, Any] | str) -> _rust.OcrQualityThresholds: ...
...
@overloaddef _to_rust_llm_config(value: LlmConfig | dict[str, Any] | str) -> _rust.LlmConfig: ...
...
@overloaddef _to_rust_acceleration_config(value: AccelerationConfig | dict[str, Any] | str) -> _rust.AccelerationConfig: ...
...
@overloaddef _to_rust_ocr_config(value: OcrConfig | dict[str, Any] | str) -> _rust.OcrConfig: ...
...
@overloaddef _to_rust_embedding_config(value: EmbeddingConfig | dict[str, Any] | str) -> _rust.EmbeddingConfig: ...
...
@overloaddef _to_rust_chunking_config(value: ChunkingConfig | dict[str, Any] | str) -> _rust.ChunkingConfig: ...
...
@overloaddef _to_rust_content_filter_config(value: ContentFilterConfig | dict[str, Any] | str) -> _rust.ContentFilterConfig: ...
...
@overloaddef _to_rust_image_extraction_config(value: ImageExtractionConfig | dict[str, Any] | str) -> _rust.ImageExtractionConfig: ...
...
@overloaddef _to_rust_hierarchy_config(value: HierarchyConfig | dict[str, Any] | str) -> _rust.HierarchyConfig: ...
...
@overloaddef _to_rust_pdf_config(value: PdfConfig | dict[str, Any] | str) -> _rust.PdfConfig: ...
...
@overloaddef _to_rust_token_reduction_options(value: TokenReductionOptions | dict[str, Any] | str) -> _rust.TokenReductionOptions: ...
...
@overloaddef _to_rust_language_detection_config(value: LanguageDetectionConfig | dict[str, Any] | str) -> _rust.LanguageDetectionConfig: ...
...
@overloaddef _to_rust_page_config(value: PageConfig | dict[str, Any] | str) -> _rust.PageConfig: ...
...
@overloaddef _to_rust_yake_params(value: YakeParams | dict[str, Any] | str) -> _rust.YakeParams: ...
...
@overloaddef _to_rust_rake_params(value: RakeParams | dict[str, Any] | str) -> _rust.RakeParams: ...
...
@overloaddef _to_rust_keyword_config(value: KeywordConfig | dict[str, Any] | str) -> _rust.KeywordConfig: ...
...
@overloaddef _to_rust_post_processor_config(value: PostProcessorConfig | dict[str, Any] | str) -> _rust.PostProcessorConfig: ...
...
@overloaddef _to_rust_html_output_config(value: HtmlOutputConfig | dict[str, Any] | str) -> _rust.HtmlOutputConfig: ...
...
@overloaddef _to_rust_security_limits(value: SecurityLimits | dict[str, Any] | str) -> _rust.SecurityLimits: ...
...
@overloaddef _to_rust_layout_detection_config(value: LayoutDetectionConfig | dict[str, Any] | str) -> _rust.LayoutDetectionConfig: ...
...
@overloaddef _to_rust_email_config(value: EmailConfig | dict[str, Any] | str) -> _rust.EmailConfig: ...
...
@overloaddef _to_rust_tree_sitter_process_config(value: TreeSitterProcessConfig | dict[str, Any] | str) -> _rust.TreeSitterProcessConfig: ...
...
@overloaddef _to_rust_tree_sitter_config(value: TreeSitterConfig | dict[str, Any] | str) -> _rust.TreeSitterConfig: ...
...
@overloaddef _to_rust_ner_config(value: NerConfig | dict[str, Any] | str) -> _rust.NerConfig: ...
...
@overloaddef _to_rust_redaction_config(value: RedactionConfig | dict[str, Any] | str) -> _rust.RedactionConfig: ...
...
@overloaddef _to_rust_summarization_config(value: SummarizationConfig | dict[str, Any] | str) -> _rust.SummarizationConfig: ...
...
@overloaddef _to_rust_extraction_config(value: ExtractionConfig | dict[str, Any] | str) -> _rust.ExtractionConfig: ...
...
@overloaddef _to_rust_metadata(value: Metadata | dict[str, Any] | str) -> _rust.Metadata: ...
...
@overloaddef _to_rust_bounding_box(value: BoundingBox | dict[str, Any] | str) -> _rust.BoundingBox: ...
...
@overloaddef _to_rust_table(value: Table | dict[str, Any] | str) -> _rust.Table: ...
...
@overloaddef _to_rust_extracted_image(value: ExtractedImage | dict[str, Any] | str) -> _rust.ExtractedImage: ...
...
@overloaddef _to_rust_ocr_confidence(value: OcrConfidence | dict[str, Any] | str) -> _rust.OcrConfidence: ...
...
@overloaddef _to_rust_ocr_element(value: OcrElement | dict[str, Any] | str) -> _rust.OcrElement: ...
...
@overloaddef _to_rust_document_structure(value: DocumentStructure | dict[str, Any] | str) -> _rust.DocumentStructure: ...
...
@overloaddef _to_rust_llm_usage(value: LlmUsage | dict[str, Any] | str) -> _rust.LlmUsage: ...
...
@overloaddef _to_rust_extraction_result(value: ExtractionResult | dict[str, Any] | str) -> _rust.ExtractionResult: ...
...
@overloaddef _to_rust_diff_options(value: DiffOptions | dict[str, Any] | str) -> _rust.DiffOptions: ...
