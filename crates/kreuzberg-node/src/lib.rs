...
// alef:hash:d200409c43c8a177f4cbbefbbf687311fbd8463e11a05e8099ec0b2b2ba4e0b2
...
pub struct AccelerationConfig {
    ...
    pub provider: Option<ExecutionProviderType>,
...
pub fn content_filter_config_default() -> ContentFilterConfig {
...
pub fn extraction_config_default() -> ExtractionConfig {
...
pub fn image_extraction_config_default() -> ImageExtractionConfig {
...
pub fn token_reduction_options_default() -> TokenReductionOptions {
...
pub fn language_detection_config_default() -> LanguageDetectionConfig {
...
pub fn html_output_config_default() -> HtmlOutputConfig {
...
pub fn layout_detection_config_default() -> LayoutDetectionConfig {
...
pub fn ocr_quality_thresholds_default() -> OcrQualityThresholds {
...
pub fn ocr_config_default() -> OcrConfig {
...
pub fn page_config_default() -> PageConfig {
...
pub fn pdf_config_default() -> PdfConfig {
...
pub fn hierarchy_config_default() -> HierarchyConfig {
...
pub fn post_processor_config_default() -> PostProcessorConfig {
...
pub struct ChunkingConfig {
    ...
    pub chunker_type: Option<ChunkerType>,
...
pub fn chunking_config_default() -> ChunkingConfig {
...
pub fn embedding_config_default() -> EmbeddingConfig {
...
pub struct TreeSitterConfig {
    ...
    pub process: Option<TreeSitterProcessConfig>,
}

#[napi(js_name = "treeSitterConfigDefault")]
pub fn tree_sitter_config_default() -> TreeSitterConfig {
...
pub struct TreeSitterProcessConfig {
    ...
    pub content_mode: Option<CodeContentMode>,
}

#[napi(js_name = "treeSitterProcessConfigDefault")]
pub fn tree_sitter_process_config_default() -> TreeSitterProcessConfig {
...
pub fn server_config_default() -> ServerConfig {
...
pub fn security_limits_default() -> SecurityLimits {
...
pub struct TokenReductionConfig {
    pub level: Option<ReductionLevel>,
...
pub fn token_reduction_config_default() -> TokenReductionConfig {
...
pub struct DocumentStructure {
    ...
    pub relationships: Option<Vec<DocumentRelationship>>,
...
pub fn document_structure_default() -> DocumentStructure {
...
pub struct ExtractionResult {
    ...
    pub processing_warnings: Option<Vec<ProcessingWarning>>,
...
pub fn extraction_result_from_ocr(ocr: OcrExtractionResult) -> ExtractionResult {
...
pub fn image_preprocessing_config_default() -> ImagePreprocessingConfig {
...
pub fn tesseract_config_default() -> TesseractConfig {
...
pub struct HtmlMetadata {
    ...
    pub headers: Option<Vec<HeaderMetadata>>,
    /// Extracted hyperlinks with type classification
    pub links: Option<Vec<LinkMetadata>>,
    /// Extracted images with source and dimensions
    pub images: Option<Vec<ImageMetadataType>>,
...
pub struct DbfMetadata {
    ...
    pub fields: Option<Vec<DbfFieldInfo>>,
}
...
pub struct OcrElementConfig {
    ...
    pub min_level: Option<OcrElementLevel>,
...
pub fn yake_params_default() -> YakeParams {
...
pub fn rake_params_default() -> RakeParams {
...
pub fn keyword_config_default() -> KeywordConfig {
...
pub fn paddle_ocr_config_with_cache_dir(cfg: PaddleOcrConfig, path: String) -> napi::Result<PaddleOcrConfig> {
    let _json =
...
pub fn paddle_ocr_config_with_table_detection(cfg: PaddleOcrConfig, enable: bool) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_angle_cls(cfg: PaddleOcrConfig, enable: bool) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_det_db_thresh(cfg: PaddleOcrConfig, threshold: f64) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_det_db_box_thresh(cfg: PaddleOcrConfig, threshold: f64) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_det_db_unclip_ratio(cfg: PaddleOcrConfig, ratio: f64) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_det_limit_side_len(cfg: PaddleOcrConfig, length: u32) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_rec_batch_num(cfg: PaddleOcrConfig, batch_size: u32) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_drop_score(cfg: PaddleOcrConfig, score: f64) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_padding(cfg: PaddleOcrConfig, padding: u32) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_with_model_tier(cfg: PaddleOcrConfig, tier: String) -> napi::Result<PaddleOcrConfig> {
    let _json =
        serde_json::to_string(&cfg).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
    let _core: kreuzberg::PaddleOcrConfig =
        serde_json::from_str(&_json).map_err(|e| napi::Error::new(napi::Status::GenericFailure, e.to_string()))?;
...
pub fn paddle_ocr_config_default() -> PaddleOcrConfig {
...
pub async fn embed_texts_async(texts: Vec<String>, config: Option<EmbeddingConfig>) -> Result<Vec<Vec<f64>>> {
    let config = config.unwrap_or_default();
